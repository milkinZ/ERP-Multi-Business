  ...
  return (
    <div>
      <div style={{ display: 'flex', justifyContent: 'space-between' }}>
        <h1 style={{ fontSize: 20, marginBottom: 12 }}>Delete Purchase Order</h1>
        <Link href={`/purchase-orders/${id}`} style={{ fontSize: 13 }}>
          ← Back
        </Link>
      </div>

      <div style={{ marginBottom: 12, padding: 12, border: '1px solid #ffccd1', background: '#fff5f5', borderRadius: 8 }}>
        <div style={{ fontWeight: 700, marginBottom: 4 }}>
          Are you sure?
        </div>
        <div style={{ fontSize: 13, color: '#666' }}>
          Deletion is allowed only when PO status is <b>DRAFT</b>. This action will soft-delete the record.
        </div>
      </div>
