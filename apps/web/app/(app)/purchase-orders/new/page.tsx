        ...
        >
          ...
          <div>
                ...
                >
                  ...
                  >
                    ...
                    <input
                      value={it.unitPrice}
                      onChange={(e) =>
                        setItemAt(idx, { unitPrice: e.target.value })
                      }
                      style={{ padding: 10 }}
                    />
                  </label>
            ...
            <div style={{ marginTop: 8, fontSize: 12, color: "#666" }}>
              * Catatan: jika endpoint daftar inventory item belum tersedia di
              frontend, daftar item akan kosong. Anda bisa pilih manual dengan
