/*
  ...
  - The values [STOK_IN,STOK_OUT] on the enum `InventoryMovementType` will be removed. If these variants are still used in the database, this will fail.

*/
-- AlterEnum
BEGIN;
CREATE TYPE "InventoryMovementType_new" AS ENUM ('STOCK_IN', 'STOCK_OUT', 'ADJUSTMENT');
